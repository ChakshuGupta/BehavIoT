...
def extract_pcap(in_pcap, out_txt, dev_name, ip_host):
    ...
    for packet in filter(None, out.decode('utf-8').split('\n')):
        ...
        if dev_name=='govee-led1' or dev_name=='philips-bulb':
            ...
            continue
        elif cur_time.astype(np.float64) > 1631120400:
            continue
...
def main():
    ...
    ip_hosts_all = {}
    model_file = '/home/chakshu/Documents/projects/iot_security/ext-repos/BehavIoT/event_inference/ip_host/ip_host_idle_nov16.model'
