...
def main():
    ...
    if in_txt.endswith('routine-dataset.txt'):
        model_file = '/home/chakshu/Documents/projects/iot_security/ext-repos/BehavIoT/event_inference/ip_host/routines.model'
    else:
        model_file = '/home/chakshu/Documents/projects/iot_security/ext-repos/BehavIoT/event_inference/ip_host/activity_nov.model'
